        ...
        input_record = {
            ...
            **window,
            "sampling": {
                ...
                "jpeg_quality": getattr(args, "jpeg_quality", 84),
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not 40 <= getattr(args, "jpeg_quality", 84) <= 100:
        parser.error("jpeg quality must be between 40 and 100")
