#!/usr/bin/env python3
"""Deprecated Temporal Guard experiment retained for historical result audits.

This entrypoint is a rejected experiment and must not be used for new runs.
Use ``qwen_experiment_action_hierarchical_v2.py`` instead.
"""
...
DEPRECATED = True
REPLACEMENT_SCRIPT = "qwen_experiment_action_hierarchical_v2.py"
DEPRECATION_MESSAGE = (
    "DEPRECATED_EXPERIMENT: qwen_experiment_action_hierarchical_v2_temporal_guard.py "
    "is archived and disabled; use qwen_experiment_action_hierarchical_v2.py"
)
