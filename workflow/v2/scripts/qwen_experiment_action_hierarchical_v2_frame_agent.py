#!/usr/bin/env python3
"""Original seven-stage v2 with bounded current-run frame requests."""
...
ALGORITHM_ID = "qwen_experiment_action_hierarchical_v2_frame_agent"
ALGORITHM_SCHEMA_VERSION = "qwen_experiment_action_hierarchical_v2_frame_agent.v1"
...
_ORIGINAL_SALVAGE_REDUCE_RESPONSE = engine.salvage_reduce_response
_ORIGINAL_SELECT_EVENTS = engine.select_events


def bind_frame_agent() -> None:
    ...
    engine.salvage_reduce_response = _ORIGINAL_SALVAGE_REDUCE_RESPONSE
    engine.select_events = _ORIGINAL_SELECT_EVENTS
